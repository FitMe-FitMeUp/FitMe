<img width="905" height="463" alt="image" src="https://github.com/user-attachments/assets/5303766d-ac3e-4734-b963-3b9d39aaf7a5" />
# 👕 FitMe!
...
- **김태언:** [링크]
- **김진우:**
- **신제원:** 아직 아는 것도 많지 않고, 생각을 말로 풀어내는 것도 서툴러서 표현이 많이 부족하다는 걸 느꼈습니다. 그럼에도 불구하고 팀원분들께서 제 이야기를 끝까지 들어주시고, 부족한 부분을 잘 이해해주시면서 피드백을 주신 점이 정말 감사했습니다.특히 제가 놓친 부분이나 잘못 이해한 내용을 친절하게 설명해주시고, 더 나은 방향으로 나아갈 수 있도록 도와주신 덕분에 많은 것을 배울 수 있었습니다.
이번 경험을 통해 단순히 지식뿐만 아니라, 소통의 중요성과 좋은 팀원과 함께하는 환경이 얼마나 큰 힘이 되는지도 느끼게 되었습니다. 앞으로는 더 정확하게 표현할 수 있도록 노력하고, 저도 다른 사람에게 도움이 되는 팀원이 되고 싶습니다.
- **이형일:**
- **최현석:**
